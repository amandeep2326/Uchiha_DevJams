    ...
    <div>
      ...
      >
        <Paper
          ...
          style={{ backgroundColor: "transparent", boxShadow: "none" ,padding:"10px 0"}}
        >
          <div className={styles.toolbarHeading}>
            <span>
              <img src={Logo} width="55x" height="55x"></img>
            </span>
            <span className={styles.toolbarText} style={{ color: "black" }}>
              LetsCode
            </span>
          </div>
          <div className={styles.avatarFlex}>
            ...
            <Link
              to="/"
              style={{ textDecoration: "none", color: "white", marginLeft: "10px", textAlign: "center" }}
            >
              Back
            </Link>
          </div>
        ...
        <Grid container direction="column">
          ...
          <Grid item className={styles.textfield}>
            ...
            <Button
              variant="contained"
              style={{ background: "#8C30F5" ,color:"white"}}
              onClick={() => {
          ...
          <Grid item className={styles.createRoom}>
            <Link to={`/room/${generate({ words: 2, alliterative: true }).dashed}`}>
              <Button variant="contained" style={{ background: "#8C30F5" ,color:"white"}}>
                Private Room
              </Button>
            </Link>
