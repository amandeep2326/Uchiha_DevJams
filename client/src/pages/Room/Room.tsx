...
const Dashboard = () => {
  ...
  // useEffect(()=>{
  //   let config = {'Authorization': 'Bearer 29006550a8f3cf527354eab6ee0436e75234fc3b776dd0ce64307318e5a0a15b'};
  //   const res = axios.post("https://lets-code.daily.co/v1/rooms" , {headers: config , 'Content-Type': 'application/json'})
  //   .then((resp) => {
  //       console.dir(resp);
  //   });
  // },[])
      ...
      <div className={style.root}>
        <ReflexContainer orientation="horizontal">
          ...
          <ReflexElement className={style.footer} flex={0.028}>
            <a href = "https://lets-code.daily.co/public-room" target = "_blank"> Join Meet Here </a>
          </ReflexElement>
        </ReflexContainer>
      </div>
